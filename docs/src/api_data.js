define({ "api": [
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Curl example",
        "content": "curl -X GET http://localhost:3000/api/v1/participants -H 'Authorization: Bearer eyJhbGciOiJIUzI1NiJ9.eyJ1c2VyX2lkIjoxLCJleHBpcnkiOjE2MDU1MjI2NTF9.fJMBMER8Sl99GBhqAUiTZn15m_OFeFlUbcVGMxDKgoY'",
        "type": "bash"
      }
    ],
    "success": {
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Curl example",
        "content": "curl http://localhost:3000/api/v1/users",
        "type": "bash"
      }
    ],
    "version": "0.0.0",
